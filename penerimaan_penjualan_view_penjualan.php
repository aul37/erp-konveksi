                                    ...
                                    <div class="card">
                                        <div class="card-header border-bottom">
                                            <div class="content-header-left col-md-9 col-12">
                                                <h4 class="card-title">Detail Penerimaan Penjualan</h4>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row mt-1">
                                                <table id="datatable-responsive-1" class="table table-striped datatables-basic table-hover" width="100%">
                                                    ...
                                                    FROM
                                                        ...
                                                        WHERE pd.billing_id = '$dataBilling' ";
                                                        $myQry     = mysqli_query($koneksi, $mySql)  or die("ANUGRAH ERP ERROR :  " . mysqli_error($koneksi));
                                                        $nomor  = 0;
                                                        $sumTotal =    0;
                                        ...
                                        <div class="card-footer">
                                            <div class="row">
                                                <div class="col-12 d-flex justify-content-between">
                                                    <a href="penerimaan_penjualan_penjualan.php" class="btn btn-outline-warning">Kembali</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
