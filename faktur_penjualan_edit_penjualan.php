...
if (isset($_POST['btnSubmit'])) {
  ...
  if (count($pesanError) >= 1) {
    ...
    try {
      ...
      // $mySql = "UPDATE billing SET billing_date = '$dataFakturDate', sales_id = '$dataRequestID', billing_note = '$dataFakturNote', updated_date = NOW() 
      //           WHERE billing_id = '$dataCode'";
      ...
      foreach ($dataDetail as $key => $value) {
        ...
        if ($dataQty > 0) {
          $mySql = "UPDATE billing_detail SET billing_quantity = '$dataQty', billing_price = '$dataPrice', updated_date = NOW() 
                    WHERE billing_detail_id = '$sales_id'";
      ...
      mysqli_commit($koneksi);
      echo "<meta http-equiv='refresh' content='0; url=faktur_penjualan_penjualan.php'>";
    } catch (Exception $e) {
      rollback();
      echo $e->getMessage();
    }
                    ...
                    <div class="row mt-1">
                      ...
                      ?>
                        ...
                        <div class="col-md-4 col-12 px-25">
                          <div class="mb-1">
                            ...
                            <input type="text" name="txtFakturID" value="<?= $dataFakturID; ?>" class="form-control" placeholder="No Faktur" required>
                          </div>
                        </div>
                      ...
                      GROUP BY s.sales_id";
                              ...
                              while ($dataRow = mysqli_fetch_array($dataQry)) {
                                $selected = ($dataRow['sales_id'] == $dataRequestID) ? "selected" : "";
                        ...
                        <div class="col-md-12 col-12 px-25">
                          <div class="mb-1">
                            ...
                            <textarea name="txtFakturNote" value="<?= $dataFakturNote; ?>" class="form-control" placeholder="Catatan" required></textarea>
                          </div>
                        </div>

                        <div class="col-md-3 col-12 pe-25">
                          <div class="mb-1" style="padding-top: 20px;">
                            <a href="faktur_penjualan_penjualan.php" class="btn btn-warning">Kembali</a>
                      ...
                      <?php } else { ?>
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td><input class="form-control form-control-sm" id="idPrice<?= $array; ?>" onkeyup="sum()" name="updPrice[<?= $array; ?>]" step="any" type="number" value="<?= $myData['billing_price']; ?>" required /></td>
                        ...
                        <div class="col-12 d-flex justify-content-between">
                          <a href="faktur_penjualan_penjualan.php" class="btn btn-outline-warning">Batalkan</a>
