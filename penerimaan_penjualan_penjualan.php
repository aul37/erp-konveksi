                    ...
                    <div class="card mb-4">
                        <div class="col-md-6 col-12">
                            <div class="mb-1 breadcrumb-right">
                                <a class="btn-icon btn btn-primary btn-round btn-sm" href="penerimaan_penjualan_add_penjualan.php">
                                    ...
                                    FROM
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="penerimaan_penjualan_view_penjualan.php?code=<?= htmlspecialchars($Code); ?>" target="_new" alt="View Data"><u><?= htmlspecialchars($myData['payment_id']); ?></u></a></td>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-warning" onclick="window.location.href='penerimaan_penjualan_edit_penjualan.php?code=<?= $Code; ?>&id=<?= $myData['payment_id']; ?>'">
                                                        Edit
                                                    </button>|
