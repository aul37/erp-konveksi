          ...
          <div class="card mb-4">
            <div class="col-md-6 col-12">
              <div class="mb-1 breadcrumb-right">
                <a class="btn-icon btn btn-primary btn-round btn-sm" href="pembayaran_pembelian_add_pembelian.php">
                  <span class="align-middle">Tambah Data Pembayaran Pembelian</span>
                </a>
              </div>
            </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><a href="pembayaran_pembelian_view_pembelian.php?code=<?= htmlspecialchars($Code); ?>" target="_new" alt="View Data"><u><?= htmlspecialchars($myData['payment_id']); ?></u></a></td>
                        ...
                        <td><?= htmlspecialchars($myData['purchase_invoice_id']); ?></td>
                        <td>
                          <button type="button" class="btn btn-warning" onclick="window.location.href='pembayaran_pembelian_edit_pembelian.php?code=<?= $Code; ?>&id=<?= $myData['payment_id']; ?>'">
                            Edit
                          </button> |
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h4 class="modal-title">Hapus Pembayaran Pembelian</h4>
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <div class="modal-body">
                              <p>Anda yakin ingin menghapus Pembayaran Pembelian <strong><?= $myData['payment_id']; ?></strong>?</p>
                              <form id="deleteForm" method="POST" action="function_pembelian.php">
                                <input type="hidden" name="payment_id" value="<?= $Code; ?>">
                                <button type="submit" class="btn btn-danger" name="hapusPP">Hapus</button>
                              </form>
                            </div>
                          </div>
                        </div>
