                    ...
                    <div class="card mb-4">
                        <div class="col-md-6 col-12">
                            <div class="mb-1 breadcrumb-right">
                                <a class="btn-icon btn btn-primary btn-round btn-sm" href="pr_add_pembelian.php">
                                      ...
                                      ORDER BY
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="pr_view_pembelian.php?code=<?= $Code; ?>" target="_new" alt="View Data"><u><?= $myData['pr_id']; ?></u></a></td>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-warning" onclick="window.location.href='pr_edit_pembelian.php?code=<?= $Code; ?>&id=<?= $myData['pr_id']; ?>'">
                                                        Edit
                                                    </button>
