                    ...
                    <div class="card mb-4">
                        <div class="col-md-6 col-12">
                            <div class="mb-1 breadcrumb-right">
                                <a class="btn-icon btn btn-primary btn-round btn-sm" href="so_add_penjualan.php">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="datatablesSimple" width="100%" cellspacing="0">
                                    ...
                                    ORDER BY
                                        ...
                                        ?>
                                            <tr>
                                                <td><a href="so_view_penjualan.php?code=<?= $Code; ?>" target="_new" alt="View Data"><u><?= $myData['sales_id']; ?></u></a></td>
                                                ...
                                                <td><button type="button" class="btn btn-warning" onclick="window.location.href='so_edit_penjualan.php?code=<?= $Code; ?>&id=<?= $myData['sales_id']; ?>'">
                                                        Edit
                                                    </button> |
