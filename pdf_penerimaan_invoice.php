  ...
  class PDF extends FPDF
  {
    ...
    function Header()
    {
      ...
      $this->Cell(190, 5, 'F A K T U R   P E M B E L I A N', '1', '0', 'C', TRUE);
      $this->Ln();
      $this->Ln();

      // Customer and Invoice Details
      $this->SetFont('arial', '', 8);
      $this->Cell(20, 4, 'Supplier :', '', '0', 'L', 0);
      $this->Cell(5, 4, ':', '', '0', 'C', 0);
      $this->Cell(60, 4, strtoupper($customer_name), '', '0', 'L', 0);
      $this->Ln();
      $this->Cell(20, 4, 'No PR', '', '0', 'L', 0);
      $this->Cell(5, 4, ':', '', '0', 'C', 0);
      $this->Cell(30, 4,  $myData['purchase_request_id'], '', '0', 'L', 0);
      $this->Ln();
  ...
  $mySql     = "SELECT * FROM view_po_detail WHERE purchase_id='$Code' ORDER BY purchase_detail_id";
  $myQry     = mysqli_query($koneksi, $mySql)  or die("ANUGRAH ERP ERROR :  " . mysqli_error($koneksi));
  $nomor  = 0;
  $sumTotal =    0;
