      ...
      <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
          <div class="nav">
            ...
            <a class="nav-link" href="index_pembelian.php">
            ...
            <div class="collapse" id="collapseMasterData" aria-labelledby="headingMasterData" data-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="product_pembelian.php">Barang</a>
                <!-- <a class="nav-link" href="user.php">User</a>
                <a class="nav-link" href="customer.php">Customer</a> -->
                <a class="nav-link" href="supplier_pembelian.php">Supplier</a>
              </nav>
            </div>
            ...
            <div class="collapse" id="collapseSales" aria-labelledby="headingSales" data-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="pr_pembelian.php">Permintaan Pembelian (PR)</a>
                <a class="nav-link" href="po_pembelian.php">Pesanan Pembelian (PO)</a>
                <a class="nav-link" href="surat_masuk_barang_pembelian.php">Surat Masuk Barang</a>
                <a class="nav-link" href="penerimaan_invoice_pembelian.php">Penerimaan Invoice</a>
                <a class="nav-link" href="pembayaran_pembelian_pembelian.php">Pembayaran Pembelian</a>
