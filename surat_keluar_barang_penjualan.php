                    ...
                    <div class="card mb-4">
                        <div class="col-md-6 col-12">
                            <div class="mb-1 breadcrumb-right">
                                <a class="btn-icon btn btn-primary btn-round btn-sm" href="surat_keluar_barang_add_penjualan.php">
                                ...
                                <table class="table table-bordered" id="datatablesSimple" width="100%" cellspacing="0">
                                    ...
                                    GROUP BY
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                <td><?= $nomor; ?></td>
                                                <td><a href="surat_keluar_barang_view_penjualan.php?code=<?= $Code; ?>" target="_new" alt="View Data"><u><?= $myData['stock_order_id']; ?></u></a></td>
                                                <td><?= $myData['stock_order_date']; ?></td>
                                                <td><?= $myData['customer_name']; ?></td>
                                                <td><?= $myData['billing_id']; ?></td>
                                                <td><?= $myData['stock_order_note']; ?></td>
                                                <td><button type="button" class="btn btn-warning" onclick="window.location.href='surat_keluar_barang_edit_penjualan.php?code=<?= $Code; ?>&id=<?= $myData['stock_order_id']; ?>'">
                                                        Edit
                                                    </button> |
