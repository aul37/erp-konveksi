                                            ...
                                            <div class="card-body">
                                                <div class="row mt-1">
                                                    <div class="col-md-4 col-12 pe-25">
                                                        <div class="mb-1">
                                                            <label>No Permintaan Pembelian </label><br /><?php echo $Code; ?>
                                                    ...
                                                    <div class="col-md-4 col-12 px-25">
                                                        <div class="mb-1">
                                                            <label>Permintaan Untuk </label><br /><?php echo $dataPurchaseFor; ?>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-12 ps-25">
                                                        <div class="mb-1">
                                                            <label>Catatan</label><br /><?php echo $dataPurchaseNote; ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $myData['pr_product'] . ' - ' . $myData['product_name']; ?></td>
