...
if (isset($_POST['btnSubmit'])) {
  ...
  if (count($pesanError) == 0) {
    try {
      ...
      $mySql = "UPDATE payment SET payment_date = '$dataPaymentDate', payment_cheque = '$dataCekDate', payment_total = '$dataPaymentTotal', payment_status = '$dataStatus', currency_value = '$dataCurrencyValue', payment_bank_sender = '$dataPaymentBankSender',payment_type = '$dataPaymentType', payment_bank = '$dataPaymentBank', payment_ref = '$dataPaymentReference', payment_note = '$dataPaymentNote', updated_date = NOW()
      ...
      foreach ($_POST['updId'] as $key => $value) {
        ...
        // if ($dataJumlah > 0) {
        $mySql = "UPDATE payment_detail SET billing_pembayaran = '$dataJumlah', billing_desc = '', created_date = NOW()
...
$mySql    = "SELECT * from view_payment WHERE  payment_id='$Code'";
...
$dataPaymentBankSender = $myData['payment_bank_sender'];
$dataPaymentTotal = $myData['billing_pembayaran'];
$dataPaymentType = $myData['payment_type'];
$dataPaymentBank = $myData['payment_bank'];
$dataBilling = $myData['billing_id'];
?>
                ...
                <div class="col-12">
                  <div class="card-body">
                    <div class="row mt-1">
                      ...
                      <?php } else { ?>
                        <input type="hidden" name="txtFaktur" value="<?= $dataCode  ?>">

                        <div class="card-body">
                          <div class="row mt-1">
                            <div class="col-md-3 col-12 px-25">
                              <div class="mb-1">
                                <label class="form-label"> Penerimaan Penjualan *</label>
                                <input type="text" name="txtPenerimaan" value="<?= $dataCode; ?>" class="form-control" placeholder="No Penerimaan Penjualan" required>
                              </div>
                            </div>
                            <div class="col-md-3 col-12 ps-25">
                              <div class="mb-1">
                                <label class="form-label">Tanggal Penerimaan Penjualan *</label>
                            ...
                            <div class="col-md-3 col-12 pe-25">
                              <div class="mb-1">
                                ...
                                <select name="txtPaymentBankSender" id="idToP" required class="select2 form-control">
                                  ...
                                  foreach ($tops as $top) {
                                    $selected = '';
                                    $cek = ($dataPaymentBankSender == $top) ? 'SELECTED' : '';
                                    echo "<option value=\"$top\" $cek>$top</option>";
                                  }
                                  ?>
                                </select>
                              ...
                              <tbody>
                                ...
                                ?>
                                  ...
                                  <tr>
                                    ...
                                    <td><?php echo $myData['billing_id']; ?></td>
