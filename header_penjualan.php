...
<body class="sb-nav-fixed">
  <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <a class="navbar-brand" href="index_penjuala.php">Anugrah Konveksi</a>
    <!-- Navbar-->
  </nav>
      ...
      <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
          <div class="nav">
            ...
            <a class="nav-link" href="index_penjualan.php">
            ...
            <div class="collapse" id="collapseMasterData" aria-labelledby="headingMasterData" data-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="product_penjualan.php">Barang</a>
                <!-- <a class="nav-link" href="user.php">User</a> -->
                <a class="nav-link" href="customer_penjualan.php">Customer</a>
            ...
            <div class="collapse" id="collapseBeli" aria-labelledby="headingSales" data-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="sales_order_penjualan.php">Sales Order</a>
                <a class="nav-link" href="faktur_penjualan_penjualan.php">Faktur Penjualan</a>
                <a class="nav-link" href="surat_keluar_barang_penjualan.php">Surat Keluar Barang</a>
